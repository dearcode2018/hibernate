 ...
 * @author qye.zheng
 * 
 * ManyToOneOfInverseTest
 */
public final class ManyToOneOfInverseTest extends BaseTest
{
	...
	public void testUpdate() {
		try {
			...
			custom.getItems().add(item);
			item.setCustom(custom);
			item.setName("天河又一城1222");
			item.setRemark("消费金额12222");
			item.setMonetary(10.34);

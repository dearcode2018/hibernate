 ...
 * UUIDSexTest
 */
public final class UUIDSexTest extends BaseTest {
	...
	public void testInsert() {
		try {
			...
			UUIDSex uuidSex = new UUIDSex();
			
			uuidSex.setName("uuidSex-" + RandomUtil.nextInt(3));
			// 持久化操作
			session.save(uuidSex);
	...
	public void testTemp() {
		try {
			...
			System.out.println("8a909eef4c9e6b5c014c9e6b60780000".length());

 ...
 * NativeTest
 */
public final class NativeTest extends BaseTest {
	...
	public void testInsert() {
		try {
			...
			Native native_ = new Native();
			
			native_.setName("native-" + RandomUtil.nextInt(3));
			// 持久化操作
			session.save(native_);

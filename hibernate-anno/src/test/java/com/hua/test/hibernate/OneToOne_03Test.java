...
import com.hua.entity.o2o._03.IdCard03;
import com.hua.entity.o2o._03.Person03;
...
public final class OneToOne_03Test extends BaseTest
{
	...
	public void testInsert01() {
		try {
			...
			person03.setName("何进");
			person03.setAddress("广州市番禺区沥滘125号");
			person03.setBirthday(DateTimeUtil.getDateTime());
			person03.setGender(Gender.MALE);
			person03.setNation("汉族");
			person03.setPhotoUrl("http://www.bai.com/resource/abc/photo.jpg");
			
			IdCard03 idCard03 = null;
			idCard03 = new IdCard03();
			// 设置身份证标题
			idCard03.setTitle("中华人民共和国 - 居民身份证");
			// 设置身份证号
			idCard03.setCardNo("54088219890705885X");
			// 设置签发机构
			idCard03.setIssuingAuthority("湛江市公安局");
			// 设置生效日期
			idCard03.setEffectiveDate(dateFormat.parse("1989-07-05"));
			idCard03.setExpiryDate(dateFormat.parse("1999-07-05"));
			...
			// 设置关联关系
			person03.setIdCard(idCard03);
			idCard03.setPerson(person03);
			 ...
			 */
			session.save(person03);
			session.save(idCard03);
	...
	public void testDelete() {
		try {
			...
			// 删除
			session.delete(person03);
			session.delete(idCard03);

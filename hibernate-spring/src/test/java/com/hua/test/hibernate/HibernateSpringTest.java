...
import com.hua.util.SpringHibernateUtil;
 ...
 * HibernateSpringTest
 */
public final class HibernateSpringTest extends BaseTest
{
	
	/* SessionFactory */
	public static final SessionFactory factory = SpringHibernateUtil.getSessionFactory();
	 ...
	 */
	@Test
	public void testInsertInSpring() {
		try {
			log.info("testInsert =====> begin");
			
			Custom custom = new Custom();
			custom.setName("spring-hibernate");
			custom.setAddress("广州市白云区");
			...
			log.error("testInsertInSpring =====> ", e);
		}
	}

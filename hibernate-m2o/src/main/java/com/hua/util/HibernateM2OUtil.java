...
public final class HibernateM2OUtil
{
	...
	public static SessionFactory buildByXml_01() {
		...
		final String filePath = "/conf/xml/hibernate.cfg_m2o_01.xml";
		// 获取Hibernate配置对象
	...
	public static SessionFactory buildByXml_02() {
		...
		final String filePath = "/conf/xml/hibernate.cfg_m2o_02.xml";
		// 获取Hibernate配置对象
		final Configuration configuration = getConfiguration(filePath);
	...
	public static SessionFactory buildByXml_03() {
		...
		final String filePath = "/conf/xml/hibernate.cfg_m2o_03.xml";
		// 获取Hibernate配置对象
		final Configuration configuration = getConfiguration(filePath);

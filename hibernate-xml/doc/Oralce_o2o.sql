...
VALUES (seq_person_oid.nextVal, '徐明', null, 1, '汉族', to_date('1973-01-16', 'yyyy-MM-dd'), '广东省广州市天河区平云路11号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '王洁', null, 2, '回族', to_date('1987-02-18', 'yyyy-MM-dd'), '新疆自治区乌鲁木齐市五山区天长路22号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '邝边', null, 0, '壮族', to_date('1983-04-15', 'yyyy-MM-dd'), '广西省玉林市玉山区广平路13号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '刘雨', null, 2, '汉族', to_date('1980-12-13', 'yyyy-MM-dd'), '江西省上饶市天水区青山路19号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '赵备', null, 0, '汉族', to_date('1992-12-31', 'yyyy-MM-dd'), '广东省广州市越秀区清水路17号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '卡扎尔-龙华', null, 1, '臧族', to_date('1979-08-11', 'yyyy-MM-dd'), '西藏自治区拉萨市东口区江北路24号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '牛芳', null, 2, '汉族', to_date('1968-01-18', 'yyyy-MM-dd'), '江苏省苏州市苏南区南江路89号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '伊尔民', null, 0, '臧族', to_date('1980-03-19', 'yyyy-MM-dd'), '云南省省昆明市昆山区海平路46号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '沙尔塔', null, 2, '维吾尔族', to_date('1976-09-08', 'yyyy-MM-dd'), '陕西省西安市汉水区西北路104号', null);

INSERT INTO person (oid, name, photoUrl, gender, nation, birthday, address, cardId) 
VALUES (seq_person_oid.nextVal, '郑飞', null, 1, '壮族', to_date('1984-02-05', 'yyyy-MM-dd'), '四川省成都市天都区天府路463号', null);

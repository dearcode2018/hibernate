...
INSERT INTO student (oid, name, gender, credit, birthday, address) 
VALUES (seq_student_oid.nextVal, '唐国强', 1, 11.0, to_date('1983-10-01', 'yyyy-MM-dd'), '上海市浦东新区南埔路93号');

INSERT INTO student (oid, name, gender, credit, birthday, address) 
VALUES (seq_student_oid.nextVal, '赵龙', 1, 13.4, to_date('1981-09-02', 'yyyy-MM-dd'), '上海市徐汇区南京路49号');

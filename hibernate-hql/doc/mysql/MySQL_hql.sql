...
INSERT INTO custom (name, balance, status, address) VALUES ('郑飞', 239.10, 1, '江苏省苏州市苏南区南江路33号');

INSERT INTO custom (name, balance, status, address) VALUES ('郑飞', 239.10, 1, '四川省成都市天都区天府路113号');

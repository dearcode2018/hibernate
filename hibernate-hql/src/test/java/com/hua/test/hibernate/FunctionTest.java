 ...
 * FunctionTest
 */
public final class FunctionTest extends BaseTest {
	...
	public void testFunction() {
		try {
			...
			String hql = "select new map"
			 + "(max(c.id) as maxId, avg(c.balance) as avgBalance, "
			 + "sum(c.balance) as sumBalance, count(distinct c.id) as count)"
			...
			System.out.println(map.get("avgBalance"));
			System.out.println(map.get("sumBalance"));
